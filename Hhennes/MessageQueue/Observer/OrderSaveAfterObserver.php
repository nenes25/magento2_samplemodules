...
class OrderSaveAfterObserver implements ObserverInterface
{
    ...
    public const QUEUE_TOPIC_NAME = 'hhennes.messagequeue.orders';
    ...
    /**
     * Add order to message queue after save
     *
    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            $this->publisher->publish(self::QUEUE_TOPIC_NAME, $order->getId());
        } catch (\Exception $e) {
            $this->logger->error(
                'Error when trying to publish order ' . $e->getMessage(),
